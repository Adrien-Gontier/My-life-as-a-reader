const books = [
    "victor_hugo_notre_dame_de_paris" = {
        ...
        "book_summary": "The plot takes place in Paris in 1482. The novel is divided into 11 books. régoire is a penniless poet. Quasimodo is tried for an attempted kidnapping. Esmeralda is arrested for a murder. And she's under the influence of witchcraft. The cathedral is obviously a special place in the unfolding of history.The novel is too large to be summarized is a few lines. So much that I can only recommend that you read it.",
        "status": "RIP"
    },
